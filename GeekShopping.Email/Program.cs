...
var myBuilder = new DbContextOptionsBuilder<MySQLServerContext>();
myBuilder.UseMySql(connection,
            new MySqlServerVersion(
                new Version(8, 0, 5)));

builder.Services.AddSingleton(new EmailRepository(myBuilder.Options));
